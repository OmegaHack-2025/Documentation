...
server.tool("add-user-summary",
  addUserSummarySchema,
  async (summaryData) => {
    const dataToInsert = {
      id: summaryData.id,
...
server.tool("update-user-summary",
  updateUserSummarySchema,
  async ({ id, ...fieldsToUpdate }) => {
